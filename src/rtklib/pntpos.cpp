...
{
    gtime_t time;
    double r,freq,dion = 0,dtrp = 0,vmeas = 0,vion = 0,vtrp = 0,rr[3],pos[3],dtr,e[3],P;
                    ...
                    double *azel, int *vsat, double *resp, char *msg)
{
    obsd_t *obs_e;
    sol_t sol_e={{0}};
    char tstr[32] = { 0 }, name[16] = { 0 }, msg_e[128] = {0};
...
* return : status(1:ok,0:error)
*-----------------------------------------------------------------------------*/
extern int pntpos(const obsd_t *obs, const int n, const nav_t *nav,
